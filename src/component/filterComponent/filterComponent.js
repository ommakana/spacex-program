...
export const FilterComponent = memo(() => {
    ...
    return (<>
        ...
        <div className="filter-button-container">
            {launchYear.map((item, index) => <button
...
function booleanButton (name) {
    return (<>
        <button className="filter-button" name={name} value="true">True</button>
        <button className="filter-button" name={name} value="false">False</button>
    </>
    )
}
